...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2aad172edcf8, const void *arg_0x2aad172ec020);
#line 780
__extension__ 
#line 797
__extension__ 
...
extern double cos(double __x) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 109
...
#line 250
extern double erfc(double arg_0x2aad1736e618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2aad175af8e8), 
int (*key_eq_fn)(void *arg_0x2aad175ae0c8, void *arg_0x2aad175ae368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2aad177bf610, int arg_0x2aad177bf878);
static double RandomUniform(void );
...
typedef TMilli LeachC$Timer0$precision_tag;
typedef TMilli LeachC$Timer1$precision_tag;
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
static void LeachC$Timer0$fired(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void LeachC$AMControl$startDone(error_t error);
#line 138
static void LeachC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void LeachC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void LeachC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void LeachC$Timer1$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
void sim_mote_enqueue_boot_event(int mote)   ;
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void LeachC$Timer0$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t LeachC$AMControl$start(void );
...
uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t LeachC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
static uint16_t LeachC$Random$rand16(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
...
uint8_t LeachC$correspond_ch[1000];
bool LeachC$ch[1000][NODE_NUM + 1];
double LeachC$position[1000][2];
bool LeachC$busy[1000];
message_t LeachC$pkt[1000];
int LeachC$lastbech[1000];
uint16_t LeachC$round[1000];
bool LeachC$hassend[1000];
bool LeachC$hasend[1000];
uint8_t LeachC$shixi[1000];
uint8_t LeachC$jieduan[1000];
static inline void LeachC$generate_rand(double x[]);
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void LeachC$Timer1$startOneShot(uint32_t dt){
#line 73
...
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t LeachC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
      ...
      if (__nesc_ntoh_uint16(btrpkt->counter.nxdata) != 3) 
        {
          ...
          if (__nesc_ntoh_uint16(btrpkt->counter.nxdata) == 2) 
            {
              ...
              sim_log_debug(166U, "Test1", "round:%d,node:%d,received start command for second time\n", LeachC$round[sim_node()], TOS_NODE_ID);
            }
          else 
            {
          ...
          r = LeachC$Random$rand16();
          x = r / (double )65535;

          if ((LeachC$round[sim_node()] - LeachC$lastbech[sim_node()] > 5 && LeachC$lastbech[sim_node()] != -1) || LeachC$lastbech[sim_node()] == -1) 
            {
              possibility = 0.2 / (1 - 0.2 * (LeachC$round[sim_node()] % 5));
            }
          if (x < possibility) 
            {
              uint8_t y;
...
#line 331
              ...
              for (y = 1; y <= NODE_NUM; y++) 
                {
                  if (LeachC$ch[sim_node()][y] == TRUE && y > TOS_NODE_ID) 
                    {
                      LeachC$shixi[sim_node()]--;
                    }
                }
              LeachC$Timer1$startOneShot((TOS_NODE_ID - 1) * 100);
            }
          else 
            {
            }
        ...
        if (__nesc_ntoh_uint16(btrpkt->counter.nxdata) == 3) 
          {
            ...
            sim_log_debug(168U, "Test1", "round:%d,node:%d,received working command\n", LeachC$round[sim_node()], TOS_NODE_ID);
            LeachC$round[sim_node()] = __nesc_ntoh_uint8(btrpkt->roundnum.nxdata);
...
#line 406
            ...
            if (LeachC$shortest[sim_node()] >= sqrt((LeachC$position[sim_node()][0] - pox) * (LeachC$position[sim_node()][0] - pox) + (LeachC$position[sim_node()][1] - poy) * (LeachC$position[sim_node()][1] - poy))) 
              {
                LeachC$shortest[sim_node()] = sqrt((LeachC$position[sim_node()][0] - pox) * (LeachC$position[sim_node()][0] - pox) + (LeachC$position[sim_node()][1] - poy) * (LeachC$position[sim_node()][1] - poy));
                LeachC$correspond_ch[sim_node()] = btrpkt->nodeid;
              }
          }
      }
    else {
...
#line 430
            sim_log_debug(169U, "Test1", "sink received,from ch_node %d and data is %lf\n", btrpkt->nodeid, btrpkt->data);
          }
        else {
          if (len == sizeof(LeachMsgData ) && TOS_NODE_ID != SINK_NODE) {
              if (LeachC$jieduan[sim_node()] == 1) 
                {
                  LeachMsgData *btrpkt = (LeachMsgData *)payload;
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2aad1792a780, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2aad1792a780) {
#line 78
    case 6:
#line 78
      __nesc_result = LeachC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2aad1792a780, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2aad179282f0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2aad179282f0, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t LeachC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 113
  LeachC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  LeachC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2aad1792b528, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2aad1792b528, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeachC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2aad17da1e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2aad17da1e18) {
#line 100
    case 0U:
#line 100
      /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2aad17da1e18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2aad178c0020){
#line 75
  switch (arg_0x2aad178c0020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2aad178c0020);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t LeachC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * LeachC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
static inline void LeachC$Timer0$fired(void )
{
  ...
  if (LeachC$busy[sim_node()] == FALSE && TOS_NODE_ID == 0) 
    {
      if (LeachC$hasend[sim_node()] == TRUE) 
        {
          LeachC$hassend[sim_node()] = FALSE;
          LeachC$hasend[sim_node()] = FALSE;
          LeachC$jieduan[sim_node()] = 0;
            ...
            if (LeachC$round[sim_node()] < 7) 
              {
                ...
                if (LeachC$AMSend$send(AM_BROADCAST_ADDR, &LeachC$pkt[sim_node()], sizeof(LeachMsgStart )) == SUCCESS) {
                    ...
                    LeachC$hassend[sim_node()] = TRUE;
                  }
              }
          }
        else {
          if (LeachC$jieduan[sim_node()] == 0 && LeachC$hassend[sim_node()] == TRUE) 
            {
              LeachMsgStart *btrpkt = (LeachMsgStart *)LeachC$Packet$getPayload(&LeachC$pkt[sim_node()], (void *)0);
...
static inline void LeachC$Timer1$fired(void )
{
  ...
  if (LeachC$busy[sim_node()] == FALSE && (TOS_NODE_ID != 0 && LeachC$jieduan[sim_node()] == 0)) 
    {
...
#line 189
      ...
      if (LeachC$AMSend$send(AM_BROADCAST_ADDR, &LeachC$pkt[sim_node()], sizeof(LeachMsgStartR )) == SUCCESS) {
          LeachC$busy[sim_node()] = TRUE;
        }
    }
  if (LeachC$busy[sim_node()] == FALSE && (TOS_NODE_ID != 0 && LeachC$jieduan[sim_node()] == 1)) 
    {
      LeachC$times[sim_node()]++;
      if (LeachC$isch[sim_node()] == FALSE) 
        {
          uint16_t r1 = LeachC$Random$rand16();
          double x1 = r1 / (double )65535;
          uint16_t r2 = LeachC$Random$rand16();
...
#line 211
          ...
          if (LeachC$AMSend$send(LeachC$correspond_ch[sim_node()], &LeachC$pkt[sim_node()], sizeof(LeachMsgData )) == SUCCESS) {
              LeachC$busy[sim_node()] = TRUE;
            }
        }
      else 
...
#line 223
          ...
          for (y = 0; y < LeachC$datanum[sim_node()]; y++) 
            {
              sum = sum + LeachC$ch_data[sim_node()][y];
              LeachC$ch_data[sim_node()][y] = 0;
            }
          if (LeachC$datanum[sim_node()] == 0) 
            {
...
#line 245
              ...
              if (LeachC$AMSend$send(SINK_NODE, &LeachC$pkt[sim_node()], sizeof(LeachMsgData )) == SUCCESS) {
                  LeachC$busy[sim_node()] = TRUE;
                }
            }
        }
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2aad18144c28){
#line 83
  switch (arg_0x2aad18144c28) {
#line 83
    case 0U:
#line 83
      LeachC$Timer0$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2aad18144c28);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2aad17dd5020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2aad17dd5020, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
static inline void LeachC$generate_rand(double x[])
{
  uint16_t r = LeachC$Random$rand16();
...
static inline void LeachC$Boot$booted(void )
{
  if (TOS_NODE_ID != 0) 
    {
      LeachC$lastbech[sim_node()] = -1;
      LeachC$generate_rand(LeachC$position[sim_node()]);
    }
  else 
    {
      LeachC$position[sim_node()][0] = 0.000000;
      LeachC$position[sim_node()][1] = 80.000000;
    }
  LeachC$AMControl$start();
}
...
#line 55
{
  /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*LeachAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 275
          if (TOS_NODE_ID != SINK_NODE && LeachC$jieduan[sim_node()] == 0) 
            ...
            if (TOS_NODE_ID != SINK_NODE && LeachC$jieduan[sim_node()] == 1) 
              {
                if (LeachC$times[sim_node()] < FRAME) 
                  {
                    LeachC$Timer1$startOneShot(NODE_NUM * 100);
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module LeachC */
  if (!strcmp(varname, "LeachC$shortest"))
  {
    *addr = (uintptr_t)&LeachC$shortest[__nesc_mote];
    *size = sizeof(LeachC$shortest[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$ch_data"))
  {
    *addr = (uintptr_t)&LeachC$ch_data[__nesc_mote];
    *size = sizeof(LeachC$ch_data[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$datanum"))
  {
    *addr = (uintptr_t)&LeachC$datanum[__nesc_mote];
    *size = sizeof(LeachC$datanum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$times"))
  {
    *addr = (uintptr_t)&LeachC$times[__nesc_mote];
    *size = sizeof(LeachC$times[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$isch"))
  {
    *addr = (uintptr_t)&LeachC$isch[__nesc_mote];
    *size = sizeof(LeachC$isch[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$correspond_ch"))
  {
    *addr = (uintptr_t)&LeachC$correspond_ch[__nesc_mote];
    *size = sizeof(LeachC$correspond_ch[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$ch"))
  {
    *addr = (uintptr_t)&LeachC$ch[__nesc_mote];
    *size = sizeof(LeachC$ch[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$position"))
  {
    *addr = (uintptr_t)&LeachC$position[__nesc_mote];
    *size = sizeof(LeachC$position[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$busy"))
  {
    *addr = (uintptr_t)&LeachC$busy[__nesc_mote];
    *size = sizeof(LeachC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$pkt"))
  {
    *addr = (uintptr_t)&LeachC$pkt[__nesc_mote];
    *size = sizeof(LeachC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$lastbech"))
  {
    *addr = (uintptr_t)&LeachC$lastbech[__nesc_mote];
    *size = sizeof(LeachC$lastbech[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$round"))
  {
    *addr = (uintptr_t)&LeachC$round[__nesc_mote];
    *size = sizeof(LeachC$round[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$hassend"))
  {
    *addr = (uintptr_t)&LeachC$hassend[__nesc_mote];
    *size = sizeof(LeachC$hassend[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$hasend"))
  {
    *addr = (uintptr_t)&LeachC$hasend[__nesc_mote];
    *size = sizeof(LeachC$hasend[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$shixi"))
  {
    *addr = (uintptr_t)&LeachC$shixi[__nesc_mote];
    *size = sizeof(LeachC$shixi[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeachC$jieduan"))
  {
    *addr = (uintptr_t)&LeachC$jieduan[__nesc_mote];
    *size = sizeof(LeachC$jieduan[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module LeachC */
  LeachC$shortest[__nesc_mote] = 9999;
  memset((void *)&LeachC$ch_data[__nesc_mote], 0, sizeof LeachC$ch_data[__nesc_mote]);
  LeachC$datanum[__nesc_mote] = 0;
  LeachC$times[__nesc_mote] = 0;
  LeachC$isch[__nesc_mote] = FALSE;
  LeachC$correspond_ch[__nesc_mote] = -1;
  memset((void *)&LeachC$ch[__nesc_mote], 0, sizeof LeachC$ch[__nesc_mote]);
  memset((void *)&LeachC$position[__nesc_mote], 0, sizeof LeachC$position[__nesc_mote]);
  LeachC$busy[__nesc_mote] = FALSE;
  memset((void *)&LeachC$pkt[__nesc_mote], 0, sizeof LeachC$pkt[__nesc_mote]);
  memset((void *)&LeachC$lastbech[__nesc_mote], 0, sizeof LeachC$lastbech[__nesc_mote]);
  LeachC$round[__nesc_mote] = 0;
  LeachC$hassend[__nesc_mote] = FALSE;
  LeachC$hasend[__nesc_mote] = FALSE;
  LeachC$shixi[__nesc_mote] = -1;
  LeachC$jieduan[__nesc_mote] = 0;
